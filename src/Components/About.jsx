...
export default function About() {
  return (
    <>
    <div className='about'>
      <img className='pic-me' src='joey-smiles.jpg' alt='beardo' />
      <p className="about-paragraph">I am a full stack developer that has a passion to create new and innovative technologies.
        ...
        My hobbies include snowboarding, hiking, camping, guitar playing, archery, disc golf and of course programming. 
